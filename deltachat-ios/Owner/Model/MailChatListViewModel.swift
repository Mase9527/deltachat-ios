//
//  MailChatListViewModel.swift
//  deltachat-ios
//
//  Created by Gongyonghui on 2026/1/26.
...
class MailChatListViewModel: NSObject {
    ...
    private func updateChatList(notifyListener: Bool) {
        ...
        self.chatList = dcContext.getUnencryptedChatlist(flags: gclFlags, queryString: nil, queryId: 0)
    ...
    func filterAndUpdateList(searchText: String) {
        ...
        searchResultChatList = dcContext.getUnencryptedChatlist(flags: DC_GCL_NO_SPECIALS, queryString: searchText, queryId: 0)
...
extension MailChatListViewModel: UISearchResultsUpdating {
